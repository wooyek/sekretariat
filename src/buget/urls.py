...
urlpatterns = [
    path('budget/<int:pk>/update', v.OpenOfficeGroupSlots.as_view(), name='OpenOfficeGroupSlots'),
    path('budget/<int:pk>/', v.OpenOfficeGroupDetail.as_view(), name='OpenOfficeGroupDetail'),
